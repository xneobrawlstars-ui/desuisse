    ...
    <>
      ...
      <section style={{ position: 'relative', height: '100vh', minHeight: 600, overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 2, height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', color: '#fff', padding: '0 40px' }}>
          ...
          {/* DeSuisse logo as SVG text — works on all devices, no external dependency */}
          <div className="fade-up fade-up-delay-1" style={{ marginBottom: 48 }}>
            <svg viewBox="0 0 420 100" xmlns="http://www.w3.org/2000/svg"
              style={{ width: 'clamp(200px, 40vw, 420px)', height: 'auto', display: 'block' }}>
              <text x="210" y="52" textAnchor="middle" dominantBaseline="middle"
                fontFamily="Cormorant Garamond, Georgia, serif"
                fontSize="52" fontWeight="300" fill="white" letterSpacing="8">
                deSuisse
              </text>
              <text x="210" y="80" textAnchor="middle" dominantBaseline="middle"
                fontFamily="Montserrat, Arial, sans-serif"
                fontSize="11" fontWeight="400" fill="rgba(201,168,76,0.9)" letterSpacing="6">
                LUXURY JEWELLERY
              </text>
            </svg>
          </div>
