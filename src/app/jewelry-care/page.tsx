  ...
  return (
    <>
      ...
      <div style={{ background: '#1a0a0a', padding: '64px 40px', textAlign: 'center' }}>
        ...
        <h1 style={{ fontFamily: 'Cormorant Garamond', fontSize: 'clamp(2.2rem, 4vw, 3.2rem)', fontWeight: 300, color: '#fff', letterSpacing: '0.06em', marginBottom: 16 }}>
          {d.title}
        </h1>
        <p style={{ fontFamily: 'Montserrat', fontSize: 13, color: '#888', maxWidth: 540, margin: '0 auto', lineHeight: 1.9 }}>{d.intro}</p>
      </div>
          ...
          <Reveal key={si} delay={si * 80}>
            <div style={{ marginBottom: 72 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 36, paddingBottom: 18, borderBottom: '2px solid #f0ebe3' }}>
                <span style={{ fontFamily: 'Montserrat', fontSize: 20, color: section.accentColor, lineHeight: 1 }}>{section.icon}</span>
                <h2 style={{ fontFamily: 'Cormorant Garamond', fontSize: '2rem', fontWeight: 400, color: '#1a0a0a', letterSpacing: '0.04em' }}>
                  {section.title}
                </h2>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: 32, alignItems: 'start' }} className="jcare-grid">
                  ...
                  {section.items.map((item, ii) => (
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
                        ...
                        <h3 style={{ fontFamily: 'Montserrat', fontSize: 12, fontWeight: 700, color: '#1a0a0a', letterSpacing: '0.06em', textTransform: 'uppercase' }}>
                          {item.title}
                        </h3>
                      </div>
                      <p style={{ fontFamily: 'Montserrat', fontSize: 13, color: '#666', lineHeight: 1.85, paddingLeft: 22 }}>
                        {item.desc}
                      </p>
                    </div>
                  ))}
                ...
                <div style={{
                  ...
                  <div>
                    <p style={{ fontFamily: 'Montserrat', fontSize: 10, color: '#ccc', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: 6 }}>
                      {d.photoNote}
                    </p>
                    <p style={{ fontFamily: 'Montserrat', fontSize: 10, color: '#ddd', letterSpacing: '0.04em' }}>
