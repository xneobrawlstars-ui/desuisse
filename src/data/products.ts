...
export interface Product {
  ...
  sku?: string;
  // Stone options
  stones?: string[];        // e.g. ['Diamond', 'Lab Diamond', 'No Stone']
  stoneSizes?: string[];    // e.g. ['0.30ct', '0.50ct', '0.75ct', '1.00ct']
  // Couple ring option
...
export const DEFAULT_PRODUCTS: Product[] = [
  {
    ...
    materialVariants: [
      { name: 'White Gold 14ct', price: 800 },
      { name: 'White Gold 18ct', price: 1050 },
      { name: 'Yellow Gold 14ct', price: 750 },
      { name: 'Yellow Gold 18ct', price: 980 },
    ],
  ...
  },
  {
    ...
    featured: true,
    materials: ['Yellow Gold', 'Rose Gold', 'White Gold'],
    materialVariants: [
      { name: 'Yellow Gold 14ct', price: 300 },
      { name: 'Yellow Gold 18ct', price: 420 },
      { name: 'Rose Gold 14ct', price: 310 },
      { name: 'Rose Gold 18ct', price: 430 },
      { name: 'White Gold 14ct', price: 340 },
      { name: 'White Gold 18ct', price: 600 },
    ],
    sizes: ['46','48','50','52','54'], sku: 'DS-002',
    hasEngraving: true,
  },
  {
    ...
    materialVariants: [
      { name: 'White Gold 18ct', price: 3000 },
      { name: 'Platinum', price: 3800 },
    ],
    sizes: ['48','50','52','54','56'], sku: 'DS-003',
    stones: ['Diamond', 'Lab Diamond', 'Moissanite'],
    stoneSizes: ['0.50ct','0.75ct','1.00ct','1.50ct','2.00ct'],
    hasEngraving: true,
  },
  {
    ...
    featured: true,
    materials: ['Rose Gold', 'Yellow Gold'],
    materialVariants: [
      { name: 'Rose Gold 14ct', price: 520 },
      { name: 'Rose Gold 18ct', price: 680 },
      { name: 'Yellow Gold 14ct', price: 510 },
      { name: 'Yellow Gold 18ct', price: 660 },
    ],
    sizes: ['46','48','50','52'], sku: 'DS-004',
    hasCoupleOption: true, hasEngraving: true,
  },
  {
    ...
    materialVariants: [
      { name: 'Yellow Gold 14ct', price: 450 },
      { name: 'Yellow Gold 18ct', price: 580 },
  ...
  },
  {
    ...
    featured: false,
    materials: ['Silver', 'White Gold'],
    materialVariants: [
      { name: 'Silver', price: 320 },
      { name: 'White Gold 14ct', price: 520 },
      { name: 'White Gold 18ct', price: 680 },
    ],
  ...
  },
  {
    ...
    materialVariants: [
      { name: 'White Gold 14ct', price: 280 },
      { name: 'White Gold 18ct', price: 380 },
    ],
